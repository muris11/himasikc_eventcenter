 ...
 <div class="py-12 bg-background min-h-screen pb-24 lg:pb-12">
     <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
         ...
         {{-- Breadcrumb --}}
         <nav class="flex mb-6 sm:mb-8 text-xs sm:text-sm" aria-label="Breadcrumb">
         ...
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
             ...
             <div class="lg:col-span-2">
                 <article class="bg-surface rounded-2xl sm:rounded-[2.5rem] border border-border overflow-hidden shadow-sm">
                     ...
                     <div class="p-4 sm:p-8 lg:p-10">
                         {{-- Header --}}
                         <div class="mb-6 sm:mb-10 border-b border-border pb-6 sm:pb-10">
                             <div class="flex flex-wrap items-center gap-2 sm:gap-3 mb-4 sm:mb-5 text-xs sm:text-sm">
                                 @if($post->category)
                             ...
                             <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                                 <div class="flex items-center gap-4">
                                     <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-md ring-2 ring-white">
                                         {{ substr($post->user->name ?? 'A', 0, 1) }}
                                     </div>
                                     <div>
                                         <p class="text-sm sm:text-base font-bold text-text-main">{{ $post->user->name ?? 'Admin' }}</p>
                                 ...
                                 <div class="flex items-center gap-3">
                                     <span class="hidden sm:inline-block text-xs font-bold text-text-muted uppercase tracking-wider mr-1">Bagikan</span>
             ...
             <div class="lg:col-span-1 space-y-6 sm:space-y-8">
                 {{-- Latest Posts Widget --}}
                  @if (isset($relatedPosts) && $relatedPosts->count() > 0)
                     <div class="bg-surface rounded-2xl sm:rounded-3xl border border-border shadow-sm p-4 sm:p-6 lg:p-8 lg:sticky lg:top-24">
                         <h3 class="font-bold text-text-main font-heading text-base sm:text-lg mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-border">Artikel Terkait</h3>
                         <div class="space-y-4 sm:space-y-5">
                             @foreach($relatedPosts as $relPost)
                                 <a href="{{ route('blog.show', $relPost) }}" class="flex gap-3 sm:gap-4 group">
                                     <div class="w-16 h-16 sm:w-20 sm:h-20 bg-surface-secondary rounded-lg sm:rounded-xl overflow-hidden shrink-0 border border-border relative">
                                         ...
                                         @else
                                             <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100">
                                                 <svg class="w-6 h-6 sm:w-8 sm:h-8 text-primary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                                             </div>
                                         @endif
                                     </div>
