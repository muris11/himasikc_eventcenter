    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-surface rounded-3xl shadow-sm border border-border overflow-hidden">
            <div class="p-6 lg:p-8 bg-surface-secondary/30 border-b border-border">
                ...
                <h1 class="text-3xl font-bold text-text-main font-heading tracking-tight">Buat Pengguna Baru</h1>
                <p class="text-text-muted mt-2">Isi formulir di bawah ini untuk menambahkan pengguna baru ke sistem.</p>
            </div>
