        ...
        <div class="bg-surface rounded-3xl shadow-sm border border-border overflow-hidden">
            <div class="p-6 lg:p-8 bg-surface-secondary/30 border-b border-border">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-text-main font-heading tracking-tight">Edit Postingan</h1>
                        <p class="text-text-muted mt-2">Perbarui konten artikel di bawah ini.</p>
                    </div>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $is_published ? 'bg-green-50 text-green-700 border border-green-100' : 'bg-surface-secondary text-text-muted border border-border' }}">
                        <span class="w-2 h-2 rounded-full {{ $is_published ? 'bg-green-500' : 'bg-text-muted/50' }} mr-2"></span>
                        {{ $is_published ? 'Dipublikasikan' : 'Draf' }}
                    </span>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="flex rounded-xl shadow-sm">
                                ...
                                <input type="text" wire:model="slug" id="slug-input" x-data
                        ...
                        <div class="col-span-2" x-data="{ imagePreview: null }">
                            ...
                            <div
                                ...
                                <div class="space-y-2 text-center">
                                    ...
                                    <input x-ref="fileInput" id="post-edit-image" wire:model="image" type="file" accept="image/*" class="hidden"
                                        @change="
                        ...
                        <div class="col-span-2">
                            <div class="flex items-center p-4 bg-surface-secondary rounded-xl border border-border">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="is_published" class="font-bold text-text-main cursor-pointer">Publikasikan</label>
                                    <p class="text-text-muted">Postingan akan terlihat oleh publik jika dicentang.</p>
                                </div>
                            </div>
                        </div>
                    </div>
