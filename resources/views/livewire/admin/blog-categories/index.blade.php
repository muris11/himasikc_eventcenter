<div>
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
        <div class="animate-fade-in-up">
            ...
            <p class="text-text-muted mt-1 text-lg">Kelola dan atur kategori untuk artikel blog</p>
        </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button wire:click="delete({{ $category->id }})"
                                        wire:confirm="Apakah Anda yakin ingin menghapus kategori blog ini?"
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-16 text-center">
                                <div class="animate-fade-in-up">
                                    ...
                                    <h3 class="text-xl font-bold text-text-main mb-2 font-heading">Belum ada Kategori Blog</h3>
                                    <p class="text-text-muted mb-6 max-w-sm mx-auto">Mulai dengan membuat kategori blog pertama Anda</p>
                                    <a href="{{ route('admin.blog-categories.create') }}"
        ...
        <div class="md:hidden grid grid-cols-1 divide-y divide-border">
            ...
            @empty
                <div class="p-8 text-center">
                    ...
                    <p class="text-text-muted text-sm font-medium">Belum ada Kategori Blog</p>
                </div>
            @endforelse
        </div>
    </div>
