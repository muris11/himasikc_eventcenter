...
<div>
    ...
    <section class="relative min-h-[85vh] flex items-center bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-3xl">
                ...
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 mb-6">
                    <span class="w-1.5 h-1.5 bg-primary-500 rounded-full animate-pulse"></span>
                    <span class="text-xs font-medium text-primary-700 dark:text-primary-400">Platform Event Mahasiswa SIKC</span>

                {{-- Main Heading with Gradient Text --}}
                {{-- Main Heading - REDUCED SIZE --}}
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-4 leading-tight">
                    Temukan Event 
                    <span class="text-primary-600 dark:text-primary-500">Masa Depanmu</span>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('events.calendar') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-slate-800 text-slate-900 dark:text-white text-sm font-semibold rounded-lg border border-slate-200 dark:border-slate-700 hover:border-primary-300 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-12 sm:py-16 bg-white dark:bg-slate-900">
            ...
            <div class="flex items-end justify-between mb-8">
                ...
                <a href="{{ route('events.index') }}" class="text-sm font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-400">
                    Lihat Semua →
                </a>
            ...
            @if($featuredEvents->count() > 0)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    @foreach($featuredEvents as $event)
                        <a href="{{ route('events.show', $event->slug) }}" class="group block card card-hover">
                            ...
                            <div class="relative h-40 rounded-t-xl overflow-hidden bg-slate-100 dark:bg-slate-700">
                                    ...
                                    <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-100 dark:from-slate-700 to-slate-50 dark:to-slate-800">
                            ...
                            <div class="p-4">
                                <div class="flex items-center gap-2 mb-2 text-xs">
                                    ...
                                    <span class="text-slate-500 dark:text-slate-400">{{ $event->date->format('d M Y') }}</span>

                                        {{-- Title --}}
                                {{-- Title - SMALLER FONT --}}
                                <h3 class="text-base font-bold text-slate-900 dark:text-white mb-1.5 line-clamp-2 group-hover:text-primary-600 dark:group-hover:text-primary-500 transition-colors">
                                        </h3>
                                ...
                                {{-- Location --}}
                                    ...
                                    <div class="flex items-center text-xs text-slate-500 dark:text-slate-400 pt-3 border-t border-slate-100 dark:border-slate-700">
                ...
                <div class="card p-12 text-center">
                    ...
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2">Belum Ada Event</h3>
                    <p class="text-sm text-slate-600 dark:text-slate-300">Nantikan event menarik segera!</p>
            @endif
        </div>
    </section>
</div>
