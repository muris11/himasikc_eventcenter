...
class SeoHelper
{
    ...
    public static function generateEventStructuredData($event)
    {
        return [
            ...
            'image' => $event->image_path ? Storage::url($event->image_path) : asset('images/og-default.jpg'),
    ...
    public static function generateBlogStructuredData($post)
    {
        return [
            ...
            'image' => $post->image_path ? Storage::url($post->image_path) : asset('images/og-default.jpg'),
            'author' => [
                '@type' => 'Person',
